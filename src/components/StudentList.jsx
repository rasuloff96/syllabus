            ...
            {students.map((student) => (
                <div key={student.id} className="bg-white shadow-lg rounded-lg p-4 flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                        <button
                            className={`px-4 py-2 rounded-lg text-white ${student.attendance ? "bg-green-500" : "bg-gray-400"
                                }`}
                        ...
                        <button
                            className={`px-4 py-2 rounded-lg text-white ${!student.attendance ? "bg-red-500" : "bg-gray-400"
                                }`}
